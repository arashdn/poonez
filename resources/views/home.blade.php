                    ...
                    <div class="col-md-4">
                        <div class="panel panel-default poonez_panel">
                            <div class="panel-heading poonez_panel_header">
                                <div class="pull-left">
                                    <span><img class="img-rounded" style="border-radius: 50%;width: 50px;height: 50px;" src="http://placehold.it/350x200"></span>&nbsp;
                                    <span><a v-bind:href="'{{route('user.profile').'/'}}'+post.user._id" style="">@{{post.user.name}}</a></span>
